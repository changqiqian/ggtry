    ...
    execute: function () {
      ...
      _export("CircleTimer", CircleTimer = (_dec = ccclass('CircleTimer'), _dec2 = property(Sprite), _dec3 = property(Label), _dec(_class = (_class2 = class CircleTimer extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        ...
        constructor() {
          ...
          _initializerDefineProperty(this, "mCount", _descriptor2, this);
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "mCount", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=e711d7c68434d42041ebaf8d71db69f5275e510a.js.map