    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = class UIMgr {
        ...
        ChangeScene(_sceneType) {
          ...
          console.log("targetListWindow=====" + targetListWindow.length); // if(this.mCurrentScene != SceneType.None)
          // {
...
//# sourceMappingURL=2dc88a63592f5471a96d5bc17227be7bccf6ed70.js.map