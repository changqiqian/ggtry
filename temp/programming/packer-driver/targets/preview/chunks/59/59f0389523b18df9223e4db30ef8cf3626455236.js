    ...
    execute: function () {
      ...
      _export("Calculator", Calculator = class Calculator {
        ...
        TryToCalculate(_publicCards, _playerCards) {
          var totalCardList = _publicCards.concat(_playerCards); //List<CardStruct> targetList = CreateCardList(tempCards);
...
//# sourceMappingURL=59f0389523b18df9223e4db30ef8cf3626455236.js.map