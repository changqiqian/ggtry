System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Node, Button, Label, BaseUI, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, ToggleBtn;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("ToggleBtn", ToggleBtn = (_dec = ccclass('ToggleBtn'), _dec2 = property(Button), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property(Label), _dec6 = property(Node), _dec(_class = (_class2 = class ToggleBtn extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        error: Error()
      }), BaseUI) : BaseUI) {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "mSelectedMark", _descriptor5, this);
        }
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "mSelectedMark", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=a187376a927fe9ce8e9b8964505b6022f0915488.js.map