  ...
  return {
    ...
    execute: function () {
      ...
      SceneConfig = class SceneConfig {
        constructor(_type, _bundles, _folders) {
          this.type = void 0;
      ...
      _export("UIMgr", UIMgr = class UIMgr {
        ...
        Init() {
          ...
          var loadingConfig = new SceneConfig(SceneType.Loading, ["loading"], resFolder);
          var loginConfig = new SceneConfig(SceneType.Login, ["login"], resFolder);
          var hallConfig = new SceneConfig(SceneType.Hall, ["hall"], resFolder);
        ...
        GetSceneConfig(_sceneType) {
          var index = this.mSceneConfig.findIndex(target => target.type === _sceneType);
        ...
        FindLayer(_key, _type) {
          var targetList = this.GetList(_type);
          var index = targetList.findIndex(target => target.key === _key);
...
//# sourceMappingURL=a1bacdd64ba3a9ab0aea7e218820672a8e2032b9.js.map