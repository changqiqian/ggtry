    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = class UIMgr {
        ...
        ChangeScene(_sceneType) {
          ...
          var targetListLayer = this.GetList(LayerType.Layer);
          var targetListWindow = this.GetList(LayerType.Window);
          console.log("targetListLayer=====" + targetListLayer.length);
          console.log("targetListWindow=====" + targetListWindow.length);
          console.log("mLayerList=====" + this.mLayerList.length);
          console.log("mWindowList=====" + this.mWindowList.length); // if(this.mCurrentScene != SceneType.None)
          // {
...
//# sourceMappingURL=e8f5aed60ff674ff9b1dd193421f07f4f31a09ea.js.map