    ...
    execute: function () {
      ...
      MsgEvent = class MsgEvent {
        ...
        Add(_msgID, _callback) {
          var keyPairIndex = this.callbackList.findIndex(_item => _item.msgID === _msgID);
          ...
          var keyPair = new MsgKeyPair(_msgID, _callback);
      ...
      _export("Network", Network = class Network {
        ...
        AddMsgListenner(_msgID, _callback, _target) {
          var index = this.mMsgListenner.findIndex(_item => _item.target === _target);
          var currentMsgEvent;
...
//# sourceMappingURL=3054c8eb132728d687a58b51c7c4aac87a5f254d.js.map