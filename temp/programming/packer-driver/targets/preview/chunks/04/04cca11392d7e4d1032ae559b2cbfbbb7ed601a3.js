System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Node, BaseUI, CardType, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, Poker;
    ...
    execute: function () {
      ...
      _export("Poker", Poker = (_dec = ccclass('Poker'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class Poker extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        ...
        static GetPokerTexturePath(_card) {
          var path = "texture/poker/";

          var num = _card.mNum.toString();
...
//# sourceMappingURL=04cca11392d7e4d1032ae559b2cbfbbb7ed601a3.js.map