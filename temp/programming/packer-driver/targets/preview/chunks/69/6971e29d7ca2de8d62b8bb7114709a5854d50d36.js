    ...
    execute: function () {
      ...
      _export("cb_ChipCtr", cb_ChipCtr = (_dec = ccclass('cb_ChipCtr'), _dec(_class = class cb_ChipCtr extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        ...
        SetChipData(_dataNotify, _param, _custmoerData, _index) {
          var currentChild = this.node.children[_index].getComponent(_crd && ToggleBtn === void 0 ? (_reportPossibleCrUseOfToggleBtn({
            error: Error()
          }), ToggleBtn) : ToggleBtn);
        ...
        ConvertNumber(_amount) {
          ...
          var tempAmount = _amount / 1000;
          var tempStr = tempAmount.toString() + "k";
          return tempStr;
        }

        Data_Money(_val, _bef) {
          for (var i = 0; i < this.node.children.length; i++) {
            var currentChild = this.node.children[i].getComponent(_crd && ToggleBtn === void 0 ? (_reportPossibleCrUseOfToggleBtn({
              error: Error()
            }), ToggleBtn) : ToggleBtn);
...
//# sourceMappingURL=6971e29d7ca2de8d62b8bb7114709a5854d50d36.js.map