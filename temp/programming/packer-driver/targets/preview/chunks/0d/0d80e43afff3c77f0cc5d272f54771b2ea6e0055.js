    ...
    execute: function () {
      ...
      _export("Calculator", Calculator = class Calculator {
        ...
        FindA2345(_targetList) {
          ...
          var card2 = this.FindTargetNumCard(_targetList, 2);
          var card3 = this.FindTargetNumCard(_targetList, 3);
          var card4 = this.FindTargetNumCard(_targetList, 4);
          var card5 = this.FindTargetNumCard(_targetList, 5);
          result.push(ace);
          result.push(card2);
          result.push(card3);
          result.push(card4);
...
//# sourceMappingURL=0d80e43afff3c77f0cc5d272f54771b2ea6e0055.js.map