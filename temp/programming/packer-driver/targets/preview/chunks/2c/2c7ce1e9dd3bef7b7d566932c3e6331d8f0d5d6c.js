      ...
      _export("HallUI", HallUI = (_dec = ccclass('HallUI'), _dec(_class = class HallUI extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        ...
        LateInit() {
          ...
          publicCards.push(new (_crd && CardStruct === void 0 ? (_reportPossibleCrUseOfCardStruct({
            error: Error()
          }), CardStruct) : CardStruct)(7, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            error: Error()
          ...
          publicCards.push(new (_crd && CardStruct === void 0 ? (_reportPossibleCrUseOfCardStruct({
            error: Error()
          }), CardStruct) : CardStruct)(6, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            error: Error()
          }), CardType) : CardType).Diamond));
...
//# sourceMappingURL=2c7ce1e9dd3bef7b7d566932c3e6331d8f0d5d6c.js.map