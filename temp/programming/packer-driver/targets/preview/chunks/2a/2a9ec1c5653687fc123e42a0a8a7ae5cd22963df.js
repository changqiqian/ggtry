System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, BaseUI, Calculator, CardStruct, CardType, Poker, _dec, _class, _crd, ccclass, property, HallUI;
  ...
  function _reportPossibleCrUseOfPoker(extras) {
    _reporterNs.report("Poker", "../common/Poker", _context.meta, extras);
  }
    ...
    execute: function () {
      ...
      _export("HallUI", HallUI = (_dec = ccclass('HallUI'), _dec(_class = class HallUI extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        ...
        LateInit() {
          ...
          publicCards.push(new (_crd && CardStruct === void 0 ? (_reportPossibleCrUseOfCardStruct({
            error: Error()
          }), CardStruct) : CardStruct)(14, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            error: Error()
          }), CardType) : CardType).Heart));
          publicCards.push(new (_crd && CardStruct === void 0 ? (_reportPossibleCrUseOfCardStruct({
            error: Error()
          }), CardStruct) : CardStruct)(2, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            error: Error()
          }), CardType) : CardType).Diamond));
          ...
          playerCards.push(new (_crd && CardStruct === void 0 ? (_reportPossibleCrUseOfCardStruct({
            error: Error()
          }), CardStruct) : CardStruct)(4, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            error: Error()
          ...
          console.log("path ==" + (_crd && Poker === void 0 ? (_reportPossibleCrUseOfPoker({
            error: Error()
          }), Poker) : Poker).GetPokerTexturePath(new (_crd && CardStruct === void 0 ? (_reportPossibleCrUseOfCardStruct({
            error: Error()
          }), CardStruct) : CardStruct)(4, (_crd && CardType === void 0 ? (_reportPossibleCrUseOfCardType({
            error: Error()
          }), CardType) : CardType).Speades)));
...
//# sourceMappingURL=2a9ec1c5653687fc123e42a0a8a7ae5cd22963df.js.map