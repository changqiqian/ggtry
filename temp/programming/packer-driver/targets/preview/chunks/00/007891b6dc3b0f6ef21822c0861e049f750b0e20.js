  ...
  return {
    ...
    execute: function () {
      ...
      _export("Poker", Poker = (_dec = ccclass('Poker'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class Poker extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        ...
        SetFront(_card) {
          var bundleName = Poker.GetPokerTexutureBundleName();
          var path = Poker.GetPokerTexturePath(_card);
...
//# sourceMappingURL=007891b6dc3b0f6ef21822c0861e049f750b0e20.js.map