          ...
          r = {
            ...
            2: [function (t, n, i) {
              ...
              for (var o = Array(64), f = Array(123), u = 0; u < 64;) {
                f[o[u] = u < 26 ? u + 65 : u < 52 ? u + 71 : u < 62 ? u - 4 : u - 59 | 43] = u++;
              }
            ...
            3: [function (t, n) {
              ...
              (n.exports = i).prototype.on = function (t, n, i) {
                ...
                if (t === d) this.t = {};else if (n === d) this.t[t] = [];else for (var i = this.t[t], r = 0; r < i.length;) {
            ...
            7: [function (t, n, i) {
              ...
              r.length = function (t) {
                for (var n = 0, i = 0, r = 0; r < t.length; ++r) {
                  (i = t.charCodeAt(r)) < 128 ? n += 1 : i < 2048 ? n += 2 : 55296 == (64512 & i) && 56320 == (64512 & t.charCodeAt(r + 1)) ? (++r, n += 4) : n += 3;
                }
                ...
                for (var r, u = null, e = [], s = 0; n < i;) {
                  (r = t[n++]) < 128 ? e[s++] = r : 191 < r && r < 224 ? e[s++] = (31 & r) << 6 | 63 & t[n++] : 239 < r && r < 365 ? (r = ((7 & r) << 18 | (63 & t[n++]) << 12 | (63 & t[n++]) << 6 | 63 & t[n++]) - 65536, e[s++] = 55296 + (r >> 10), e[s++] = 56320 + (1023 & r)) : e[s++] = (15 & r) << 12 | (63 & t[n++]) << 6 | 63 & t[n++], 8191 < s && ((u = u || []).push(String.fromCharCode.apply(String, e)), s = 0);
                }
                ...
                for (var r, u, e = i, s = 0; s < t.length; ++s) {
                  (r = t.charCodeAt(s)) < 128 ? n[i++] = r : (r < 2048 ? n[i++] = r >> 6 | 192 : (55296 == (64512 & r) && 56320 == (64512 & (u = t.charCodeAt(s + 1))) ? (r = 65536 + ((1023 & r) << 10) + (1023 & u), ++s, n[i++] = r >> 18 | 240, n[i++] = r >> 12 & 63 | 128) : n[i++] = r >> 12 | 224, n[i++] = r >> 6 & 63 | 128), n[i++] = 63 & r | 128);
                }
            ...
            17: [function (t, n) {
              ...
              u.n = function () {
                u.alloc = r.u, u.writeBytesBuffer = r.Buffer && r.Buffer.prototype instanceof Uint8Array && "set" === r.Buffer.prototype.set.name ? function (t, n, i) {
                  ...
                  if (t.copy) t.copy(n, i, 0, t.length);else for (var r = 0; r < t.length;) {
                    n[i++] = t[r++];
                  }
                };
...
//# sourceMappingURL=21fd966966c0780b631da14154297bf1a82be41f.js.map