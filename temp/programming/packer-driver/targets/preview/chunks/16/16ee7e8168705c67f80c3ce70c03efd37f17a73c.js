    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = class UIMgr {
        ...
        RecordLayer(_key, _node, _type) {
          ...
          var temp = this.GetList(_type);
          console.log("this.temp====" + temp.length);
          console.log("this.mLayerList====" + this.mLayerList.length);
          console.log("this.mWindowList====" + this.mWindowList.length);
        }
...
//# sourceMappingURL=16ee7e8168705c67f80c3ce70c03efd37f17a73c.js.map