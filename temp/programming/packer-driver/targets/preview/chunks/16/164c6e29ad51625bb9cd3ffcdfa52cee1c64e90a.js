System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, BaseUI, CardStruct, CardType, _dec, _class, _crd, ccclass, property, HallUI;
      ...
      _export("HallUI", HallUI = (_dec = ccclass('HallUI'), _dec(_class = class HallUI extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        ...
        LateInit() {
          ...
          playerCards.push(new (_crd && CardStruct === void 0 ? (_reportPossibleCrUseOfCardStruct({
            ...
            error: Error()
          }), CardType) : CardType).Diamond)); //Calculator.GetInstance().TryToCalculate(publicCards,playerCards);
        }
...
//# sourceMappingURL=164c6e29ad51625bb9cd3ffcdfa52cee1c64e90a.js.map