System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Label, BaseUI, PlayerInfo, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, cb_BottomArea;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("cb_BottomArea", cb_BottomArea = (_dec = ccclass('cb_BottomArea'), _dec2 = property(_crd && PlayerInfo === void 0 ? (_reportPossibleCrUseOfPlayerInfo({
        error: Error()
      }), PlayerInfo) : PlayerInfo), _dec3 = property(Label), _dec(_class = (_class2 = class cb_BottomArea extends (_crd && BaseUI === void 0 ? (_reportPossibleCrUseOfBaseUI({
        error: Error()
      }), BaseUI) : BaseUI) {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=b4c544dc17aa1bbb8f6eebc3ca23ec3d5ea2ea1f.js.map