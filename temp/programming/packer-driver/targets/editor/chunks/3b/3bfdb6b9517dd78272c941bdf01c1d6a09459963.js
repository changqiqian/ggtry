  ...
  return {
    ...
    execute: function () {
      ...
      _export("ResMgr", ResMgr = class ResMgr {
        ...
        GetAssetInBundle(_bundleName, _assetName, _assetType, _loadFinish) {
          var bundleInCache = this.FindBundleInCache(_bundleName);
          ...
          bundleInCache.value.load(_assetName, _assetType, (_error, _asset) => {
            if (_error != null) {
...
//# sourceMappingURL=3bfdb6b9517dd78272c941bdf01c1d6a09459963.js.map