    ...
    execute: function () {
      ...
      _export("Calculator", Calculator = class Calculator {
        ...
        TryToCalculate(_publicCards, _playerCards) {
          let tempPublicCards = JSON.parse(JSON.stringify(_publicCards));
          let tempPlayerCards = JSON.parse(JSON.stringify(_playerCards));
...
//# sourceMappingURL=80f3c03ff1fbd0ec77b897c935678d975b5dac38.js.map