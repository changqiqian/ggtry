...
export class Localization {
    ...
    public static LocationData = [
        ...
        { name: '00348', ch: '今日', en: 'Today' },
        { name: '00349', ch: '7日', en: '7 days' },
        { name: '00350', ch: '30日', en: '30 days' },
        { name: '00351', ch: '盈亏', en: 'Profit' },
        { name: '00352', ch: '牌局编号', en: 'Game code' },
        { name: '00353', ch: '房间名称', en: 'Room name' },
        { name: '00354', ch: '游戏类型', en: 'Game type' },
        { name: '00355', ch: '座位数', en: 'Seats' },
        { name: '00356', ch: '盲注', en: 'Blind' },
        { name: '00357', ch: '总手数', en: 'Total Hands' },
        { name: '00358', ch: '总带入', en: 'Total Chips' },
        { name: '00359', ch: '玩家', en: 'Player' },
        { name: '00360', ch: '输赢', en: 'Result' },
        { name: '00361', ch: '牌局概述', en: 'Genera infos' },
        { name: '00362', ch: '牌谱', en: 'Recipes' },
        { name: '00363', ch: '战绩详情', en: 'Details' },
        { name: '00364', ch: '获胜玩家', en: 'Winner' },
        { name: '00365', ch: '我的手牌', en: 'My cards' },
