...
$root.PokerLife = (function() {
    ...
    PokerLife.MessageHeader = (function() {

        /**
         * Properties of a MessageHeader.
         * @memberof PokerLife
         * @interface IMessageHeader
         * @property {PokerLife.MsgStatus} msgStatus MessageHeader msgStatus
         * @property {PokerLife.ErrorCode|null} [errorCode] MessageHeader errorCode
         ...
         * @constructor
         * @param {PokerLife.IMessageHeader=} [p] Properties to set
         */
         ...
         * @member {PokerLife.MsgStatus} msgStatus
         * @memberof PokerLife.MessageHeader
         * @instance
         */
         ...
         * @member {PokerLife.ErrorCode} errorCode
         * @memberof PokerLife.MessageHeader
         * @instance
         */
         ...
         * @memberof PokerLife.MessageHeader
         * @static
         * @param {PokerLife.IMessageHeader} m MessageHeader message or plain object to encode
         ...
         * @returns {PokerLife.MessageHeader} MessageHeader
        ...
        MessageHeader.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.PokerLife.MessageHeader();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
    ...
    /**
     * MsgStatus enum.
     * @name PokerLife.MsgStatus
     * @enum {number}
     * @property {number} Success=0 Success value
     * @property {number} Failed=1 Failed value
     */
    PokerLife.MsgStatus = (function() {
    ...
    /**
     * ErrorCode enum.
     * @name PokerLife.ErrorCode
     * @enum {number}
     * @property {number} Unknow=0 Unknow value
     */
    PokerLife.ErrorCode = (function() {
        var valuesById = {}, values = Object.create(valuesById);
    ...
    PokerLife.register = (function() {
        ...
        register.C2S_Register = (function() {
             ...
             * @property {PokerLife.IUserBaseInfo} baseInfo C2S_Register baseInfo
             ...
             * @member {PokerLife.IUserBaseInfo} baseInfo
            ...
            C2S_Register.encode = function encode(m, w) {
                if (!w)
                    w = $Writer.create();
                $root.PokerLife.UserBaseInfo.encode(m.baseInfo, w.uint32(10).fork()).ldelim();
            ...
            C2S_Register.decode = function decode(r, l) {
                ...
                while (r.pos < c) {
                    ...
                    switch (t >>> 3) {
                    case 1:
                        m.baseInfo = $root.PokerLife.UserBaseInfo.decode(r, r.uint32());
                        break;
                    case 2:
                        m.password = r.string();
                        break;
    ...
    PokerLife.C2S_GetUserInfo = (function() {
         ...
         * @constructor
         * @param {PokerLife.IC2S_GetUserInfo=} [p] Properties to set
         */
         ...
         * C2S_GetUserInfo uid.
         * @member {number} uid
         * @memberof PokerLife.C2S_GetUserInfo
         * @instance
         */
         ...
         * @memberof PokerLife.C2S_GetUserInfo
         * @static
         * @param {PokerLife.IC2S_GetUserInfo} m C2S_GetUserInfo message or plain object to encode
         * @param {protobuf.Writer} [w] Writer to encode to
         * @returns {protobuf.Writer} Writer
         */
         ...
         * @param {protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {PokerLife.C2S_GetUserInfo} C2S_GetUserInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        C2S_GetUserInfo.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.PokerLife.C2S_GetUserInfo();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
    ...
    PokerLife.S2C_GetUserInfo = (function() {

        /**
         * Properties of a S2C_GetUserInfo.
         * @memberof PokerLife
         * @interface IS2C_GetUserInfo
         * @property {PokerLife.IUserInfo} userInfo S2C_GetUserInfo userInfo
         */
         ...
         * @constructor
         * @param {PokerLife.IS2C_GetUserInfo=} [p] Properties to set
         */
         ...
         * @member {PokerLife.IUserInfo} userInfo
         * @memberof PokerLife.S2C_GetUserInfo
         * @instance
         */
         ...
         * @memberof PokerLife.S2C_GetUserInfo
         * @static
         * @param {PokerLife.IS2C_GetUserInfo} m S2C_GetUserInfo message or plain object to encode
         * @param {protobuf.Writer} [w] Writer to encode to
         * @returns {protobuf.Writer} Writer
         */
        S2C_GetUserInfo.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            $root.PokerLife.UserInfo.encode(m.userInfo, w.uint32(10).fork()).ldelim();
            return w;
        };
         ...
         * @param {protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {PokerLife.S2C_GetUserInfo} S2C_GetUserInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        S2C_GetUserInfo.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.PokerLife.S2C_GetUserInfo();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
                    m.userInfo = $root.PokerLife.UserInfo.decode(r, r.uint32());
                    break;
                default:
                    r.skipType(t & 7);
                    break;
    ...
    PokerLife.UserInfo = (function() {
         ...
         * @property {PokerLife.IUserBaseInfo} baseInfo UserInfo baseInfo
         * @property {PokerLife.IUserAssets} userAssets UserInfo userAssets
         * @property {PokerLife.IUserAccountInfo} userAccountInfo UserInfo userAccountInfo
         */
         ...
         * @constructor
         * @param {PokerLife.IUserInfo=} [p] Properties to set
         */
        function UserInfo(p) {
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
        ...
        /**
         * UserInfo userAssets.
         * @member {PokerLife.IUserAssets} userAssets
         * @memberof PokerLife.UserInfo
         * @instance
         */
         ...
         * @member {PokerLife.IUserAccountInfo} userAccountInfo
         * @memberof PokerLife.UserInfo
         * @instance
         */
         ...
         * @memberof PokerLife.UserInfo
         * @static
         * @param {PokerLife.IUserInfo} m UserInfo message or plain object to encode
         * @param {protobuf.Writer} [w] Writer to encode to
         * @returns {protobuf.Writer} Writer
         */
        UserInfo.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            w.uint32(8).int32(m.uid);
            $root.PokerLife.UserBaseInfo.encode(m.baseInfo, w.uint32(18).fork()).ldelim();
            $root.PokerLife.UserAssets.encode(m.userAssets, w.uint32(26).fork()).ldelim();
            $root.PokerLife.UserAccountInfo.encode(m.userAccountInfo, w.uint32(34).fork()).ldelim();
            return w;
        };
         ...
         * @param {protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {PokerLife.UserInfo} UserInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        UserInfo.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.PokerLife.UserInfo();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    m.userAssets = $root.PokerLife.UserAssets.decode(r, r.uint32());
                    break;
                case 4:
                    m.userAccountInfo = $root.PokerLife.UserAccountInfo.decode(r, r.uint32());
                    break;
                default:
                    r.skipType(t & 7);
                    break;
    ...
    PokerLife.UserBaseInfo = (function() {
         ...
         * @constructor
         * @param {PokerLife.IUserBaseInfo=} [p] Properties to set
         */
         ...
         * @memberof PokerLife.UserBaseInfo
         * @instance
         */
         ...
         * @memberof PokerLife.UserBaseInfo
         * @static
         * @param {PokerLife.IUserBaseInfo} m UserBaseInfo message or plain object to encode
         * @param {protobuf.Writer} [w] Writer to encode to
         * @returns {protobuf.Writer} Writer
         */
         ...
         * @param {protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {PokerLife.UserBaseInfo} UserBaseInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        UserBaseInfo.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.PokerLife.UserBaseInfo();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
    ...
    PokerLife.UserAssets = (function() {
         ...
         * @constructor
         * @param {PokerLife.IUserAssets=} [p] Properties to set
         */
         ...
         * @memberof PokerLife.UserAssets
         * @static
         * @param {PokerLife.IUserAssets} m UserAssets message or plain object to encode
         * @param {protobuf.Writer} [w] Writer to encode to
         * @returns {protobuf.Writer} Writer
         */
         ...
         * @param {protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {PokerLife.UserAssets} UserAssets
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        UserAssets.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.PokerLife.UserAssets();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
    ...
    PokerLife.UserAccountInfo = (function() {

        /**
         * Properties of a UserAccountInfo.
         * @memberof PokerLife
         * @interface IUserAccountInfo
         * @property {PokerLife.AccountLevel} accountLevel UserAccountInfo accountLevel
         * @property {PokerLife.AccountStauts} accountStatus UserAccountInfo accountStatus
         */
         ...
         * @constructor
         * @param {PokerLife.IUserAccountInfo=} [p] Properties to set
         */
         ...
         * @member {PokerLife.AccountLevel} accountLevel
         * @memberof PokerLife.UserAccountInfo
         * @instance
         */
         ...
         * @member {PokerLife.AccountStauts} accountStatus
         * @memberof PokerLife.UserAccountInfo
         * @instance
         */
         ...
         * @memberof PokerLife.UserAccountInfo
         * @static
         * @param {PokerLife.IUserAccountInfo} m UserAccountInfo message or plain object to encode
         * @param {protobuf.Writer} [w] Writer to encode to
         * @returns {protobuf.Writer} Writer
         */
         ...
         * @param {protobuf.Reader|Uint8Array} r Reader or buffer to decode from
         * @param {number} [l] Message length if known beforehand
         * @returns {PokerLife.UserAccountInfo} UserAccountInfo
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {protobuf.util.ProtocolError} If required fields are missing
         */
        UserAccountInfo.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.PokerLife.UserAccountInfo();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
    ...
    /**
     * AccountStauts enum.
     * @name PokerLife.AccountStauts
     * @enum {number}
     * @property {number} Normal=0 Normal value
     * @property {number} Frozen=1 Frozen value
     */
    PokerLife.AccountStauts = (function() {
        var valuesById = {}, values = Object.create(valuesById);
